...
class CrearTablasVales extends Migration {
	...
	public function up()
	{
		Schema::create('vales', function($table)
		{
			$table->increments('id');
		...
		Schema::create('rm_vale', function($table)
		{
			$table->increments('id');
		...
		Schema::create('objetivo_vale', function($table)
		{
			$table->increments('id');
			$table->integer('vale_id')->unsigned();
		...
		Schema::create('factura_vale', function($table)
		{
			$table->increments('id');
			$table->integer('vale_id')->unsigned();
