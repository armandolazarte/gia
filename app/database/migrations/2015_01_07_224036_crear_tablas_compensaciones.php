...
class CrearTablasCompensaciones extends Migration {
	...
	public function up()
	{
		Schema::create('compensa_rms', function($table)
		{
			$table->increments('id');
		...
		Schema::create('compensa_origenes', function($table)
		{
			$table->increments('id');
		...
		Schema::create('compensa_destinos', function($table)
		{
			$table->increments('id');
			$table->integer('compensa_rm_id')->unsigned();
			$table->foreign('compensa_rm_id')->references('id')->on('compensa_rms');
		...
		Schema::create('urg_externas', function($table)
		{
			$table->increments('id');
		...
		Schema::create('compensa_externas', function($table)
		{
			$table->increments('id');
			$table->integer('compensa_rm_id')->unsigned();
			$table->foreign('compensa_rm_id')->references('id')->on('compensa_rms');
