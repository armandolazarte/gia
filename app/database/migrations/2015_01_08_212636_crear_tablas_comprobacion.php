...
class CrearTablasComprobacion extends Migration {
	...
	public function up()
	{
		Schema::create('comps', function($table)
		{
			$table->increments('id');
		...
		Schema::create('comp_egreso', function($table)
		{
			$table->increments('id');
		...
		Schema::create('comp_factura', function($table)
		{
			$table->increments('id');
			$table->integer('comp_id')->unsigned();
		...
		Schema::create('paquetes', function($table)
		{
			$table->increments('id');
			$table->string('estatus', 20);
			$table->smallInteger('elabora')->unsigned();
		...
		Schema::create('comp_paquete', function($table)
		{
			$table->increments('id');
		...
		Schema::create('comp_devs', function($table)
		{
			$table->increments('id');
			$table->integer('comp_id')->unsigned();
		...
		Schema::create('comp_devs_rms', function($table)
		{
			$table->increments('id');
