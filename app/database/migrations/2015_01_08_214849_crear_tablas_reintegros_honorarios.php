...
class CrearTablasReintegrosHonorarios extends Migration {
	...
	public function up()
	{
		Schema::create('reintegros', function($table)
		{
			$table->increments('id');
			$table->date('fecha');
		...
		Schema::create('reintegro_rm', function($table)
		{
			$table->increments('id');
		...
		Schema::create('reintegro_vale', function($table)
		{
			$table->increments('id');
			$table->integer('reintegro_id')->unsigned();
		...
		Schema::create('honorarios', function($table)
		{
			$table->increments('id');
			$table->decimal('monto', 15, 3);
