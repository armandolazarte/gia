...
class CrearTablasSolicitudes extends Migration {
	...
	public function up()
	{
		...
		Schema::create('solicitudes_devs', function($table)
		{
			$table->increments('id');
		...
		Schema::create('factura_solicitud', function($table)
		{
			$table->increments('id');
			$table->integer('solicitud_id')->unsigned();
		...
		Schema::create('rm_solicitud', function($table)
		{
			$table->increments('id');
			$table->integer('solicitud_id')->unsigned();
		...
		Schema::create('objetivo_solicitud', function($table)
		{
			$table->increments('id');
			$table->integer('solicitud_id')->unsigned();
		...
		Schema::create('egreso_solicitud', function($table)
		{
			$table->increments('id');
			$table->integer('solicitud_id')->unsigned();
